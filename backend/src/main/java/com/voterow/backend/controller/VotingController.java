...
public class VotingController {
    ...
    @PostMapping("/cast")
    public ResponseEntity<Map<String, Object>> castVote(@RequestBody Map<String, Object> voteData) {
        try {
            // Input validation
    ...
    public ResponseEntity<Map<String, Object>> checkVoteStatus(@PathVariable Long voterId, @PathVariable Long electionId) {
