-- Sample data for testing complete voting flow
...
(1, 'Admin User', 'admin@test.com', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi.', 30, 'ROLE_ADMIN', 'SUPER_ADMIN', true, true, false, NOW(), NOW()),
